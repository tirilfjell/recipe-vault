...
const en = {
  ...
  "settings.languageHint": "The whole interface changes straight away. Automatic follows your browser.",
  "settings.languageAuto": "Automatic",
  "settings.themeHeading": "Appearance",
  "settings.themeHint": "Follow the system, or choose light or dark. Your choice is remembered on this device.",
...
const nb = {
  ...
  "settings.languageHint": "Hele grensesnittet endres med én gang. Automatisk følger nettleseren din.",
  "settings.languageAuto": "Automatisk",
  "settings.themeHeading": "Utseende",
  "settings.themeHint": "Følg systemet, eller velg lyst eller mørkt. Valget ditt huskes på denne enheten.",
  "settings.themeSystem": "Systemet",
